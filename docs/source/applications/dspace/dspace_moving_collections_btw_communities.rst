...
-----------------------------------------------------------
- If the collection is already created, you can copy the collection's handle.
- If you need to create a new collection, follow the creation steps in the new community.
