...
.. mermaid::
    ...
    A[IDEA Document submitted<br/>(Stakeholder)]
    B[Added to Pre-Project Checklist<br/>(Mark)]
    C[Inventory submitted<br/>(Stakeholder)]
    D[Access Rights Review submitted<br/>(Stakeholder)]
    E[IDEA review meeting scheduled<br/>(Mark)]

    F[Content reviewed by DPMT]
    G[Feasibility Review created<br/>(Mark)]
    H[Project Kickoff meeting scheduled<br/>(Mark)]

    I[Metadata needs defined<br/>(Jeannette)]
    J[Repository & discovery platform selected<br/>(Mark)]
    K[Access restrictions defined<br/>(John)]
    L[Digitization needs defined<br/>(Phelan)]
    M[Added to Project Snapshot<br/>(Mark)]

    N[Collection processed / sent to DiSC<br/>(Jaq)]
    O[Items scanned to CIFS<br/>(Phelan)]
    P[Files processed on CIFS<br/>(Kaila)]
    Q[Service files generated<br/>(Mark)]
    R[Inventory refined from scans<br/>(Jeannette)]

    S[Metadata packaged with SAF Creator<br/>(Jeannette)]
    T[Ingested to pre-production repository<br/>(Mark)]
    U[QA review by DPMT]
    V[Ingested to production repository<br/>(Mark)]

    W[Collection or exhibit content written<br/>(Mark)]
    X[Thumbnail & description sent to Bonnie<br/>(Mark)]
    Y[Catalog record created (if applicable)<br/>(Jeannette)]
    Z[Added to Digital Collections website<br/>(Bonnie)]
    AA[Collection preserved<br/>(Abi)]
